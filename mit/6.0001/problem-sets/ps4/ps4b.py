...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(LENGTH):
            if (i + shift) < LENGTH:
                lower.append(LOWERCASE[i + shift])
                upper.append(UPPERCASE[i + shift])
            else:
                lower.append(LOWERCASE[i + shift - LENGTH])
                upper.append(UPPERCASE[i + shift - LENGTH])
...
if __name__ == '__main__':
    ...
    # PlaintextMessage example test cases
    plaintext1 = PlaintextMessage('It was the best of times...', 7)
