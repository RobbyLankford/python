...
def test_tiny_acted_together():
    # Simple test on db_tiny, two actors who acted together
    actor1 = 2876
    actor2 = 4724
...
def test_tiny_bacon_path():
    # Bacon path, tiny database, length of 2 (3 actors, 2 movies)
    actor_id = 1640
    len_expected = 2
...
def test_bacon_path_07():
    # Bacon path from section 6.1: actor 1604 in tiny.pickle
    actor_id = 1604
    expected = None
    result = lab.bacon_path(db_tiny, actor_id)
    assert result == expected
...
def test_tiny_actor_to_actor_path():
    # Actor path, tiny database, length of length of 2 (3 actors, 2 movies)
    actor_1 = 1532
    actor_2 = 1640
    len_expected = 2
