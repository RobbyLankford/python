...
- Lists are *mutable*, meaning that they can be modified
...
- Common Error Messages
  - **IndexError: list index out of range**
    - Occurs when we try to access an invalid index in a list
  - **TypeError: list indicies must be integers or slices, not...**
    - Occurs when we try to use a value as an index that is not an integer
  - **TypeError: '...' object is not subsriptable**
    - Occurs when we try to use square brackets to index into ("subscript") an object that does not support it
...
- Common Error Messages
  - **ValueError: list.remove(x): x not in list**
    - Occurs when we try to use `.remove()` to remove an element from a list, but that element is not present in the list
  - **IndexError: pop index out of range**
    - Occurs when the index given to `.pop()` is not a valid index into the relevant list
  - **IndexError: pop from empty list**
    - Occurs when we try to call `.pop()` with an empty list
...
- Common Error Messages
  - **TypeError: can only concatenate list (not "...") to list**
    - Occurs when we try to use `+` when the left-side operand is a list but the right-side operand is not
